...
export default function FloatingChat() {
  ...
  <button 
    ...
    className="
      ...
      w-14 h-14 sm:w-[4.6rem] sm:h-[5.4rem]
    "
  ...
  {chatOpen && (
    ...
    ">
      ...
      <div className="bg-[#012437] text-white p-4 rounded-t-lg">
        <img src="logo.svg" alt="Logo" className="w-[6.6rem] h-[2.9rem] pb-[0.7rem]" />
      ...
      <div className="p-3 bg-white border-t rounded-b-lg">
        <form onSubmit={(e) => { e.preventDefault(); handleSend() }} className="flex gap-2">
          ...
          />
          <button type="submit" className="bg-[#012437] text-white px-4 py-2 rounded-xl text-sm">Enviar</button>
        </form>
      </div>
    </div>
  )}
